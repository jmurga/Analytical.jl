...
=#
function readSimulations(;analysis::String,b::Float64,n::Int64,dac::Array{Int64,1},output::String="/home/jmurga/mkt/202004/results/simulations/alphasModel",path::String="/home/jmurga/mkt/202004/rawData/simulations/")
	#=	analysis="noDemog_0.4_0.3_0.999"
	...
	param = Analytical.parameters(N=5000,n=n,B=b,gam_neg=-457,gL=10,gH=500,al=0.184,be=0.000402,alTot=α,alLow=αW,Lf=2*10^5,bRange = br)
	# param.nn = param.nn+1
...
df1 = readSimulations(analysis="noDemog_0.4_0.1_0.2",n=500,b=0.1,dac=collect(1:999))
df2 = readSimulations(analysis="noDemog_0.4_0.3_0.2",n=500,b=0.15,dac=collect(1:999))
df3 = readSimulations(analysis="noDemog_0.4_0.1_0.999",n=500,b=0.999,dac=collect(1:999))
df4 = readSimulations(analysis="tennesen_0.4_0.3_0.999",n=500,b=0.6,dac=collect(1:999))
