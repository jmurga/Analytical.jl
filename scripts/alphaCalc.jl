...
function summStats(iter::Int64,data::Array,output::String)
	...
	# for i in 1:iter
		...
		# j = 0.999
			...
			Analytical.changeParameters(gam_neg=gam_neg,gL=gL,gH=gH,alLow=alLow,alTot=alTot,theta_f=1e-3,theta_mid_neutral=1e-3,al=0.4,be=0.000402,B=j,bRange=adap.bRange,pposL=0.001,pposH=0.0,N=1000,n=661,Lf=10^6,rho=adap.rho,TE=5.0,diploid=true,convoluteBinomial=false)
...
summStats(1,empiricalValues,"/home/jmurga/prior")
summStats(117648,empiricalValues,"/home/jmurga/prior")
