...
empiricalValues = Analytical.parseSfs(data=files[1],output="/home/jmurga/data.tsv",sfsColumns=[3,5],divColumns=[6,7],bins=20)
...
summStats(5,empiricalValues,"/home/jmurga/prior.tsv")
