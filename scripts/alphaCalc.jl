...
empiricalValues = Analytical.parseSfs(data=files,output="/home/jmurga/data2.tsv",sfsColumns=[3,5],divColumns=[6,7],bins=20)
...
function summStats(iter::Int64,data::Array,output::String)
	...
	# for i in 1:iter
		...
		alTot=rand(collect(0.0:0.1:0.5))
...
summStats(58824,empiricalValues,"/home/jmurga/prior2.tsv")
